  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-5">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-slate-300/80 border border-slate-100 p-5">
        ...
        <div className="">
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight text-center mb-4">Login</h2>
          <p className="text-slate-500 text-sm mb-4">Acesse sua conta para continuar.</p>
        </div>
